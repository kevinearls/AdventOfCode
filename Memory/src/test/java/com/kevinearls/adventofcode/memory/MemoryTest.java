...
public class MemoryTest {
    ...
    public void testExampleData() {
        Integer[] testData = {0, 2, 7, 0};
        int result = memory.calculateCycles(testData);
    ...
    public void answerTest() {
        Integer[] realData = {10, 3, 15, 10, 5, 15, 5, 15, 9, 2, 5, 8, 5, 2, 3, 6};
        int result = memory.calculateCycles(realData);
        System.out.println("This took " + result + " steps");
        assertEquals(14029, result);
    }
}
